<div class="sidebar has-scrollbar" data-mobile-menu>
  ...
  <div class="sidebar-category">
    ...
    <div class="sidebar-top">
      <h2 class="sidebar-title"><?php esc_html_e('Categorías', 'anon-theme'); ?></h2>
    ...
    <ul class="sidebar-menu-category-list">
      ...
      <li class="sidebar-menu-category">
        <a href="<?php echo esc_url(get_term_link($cat)); ?>" class="sidebar-accordion-menu">
          ...
          <data value="<?php echo esc_attr($cat->count); ?>" class="stock" title="<?php esc_attr_e('Stock disponible', 'anon-theme'); ?>"><?php echo esc_html($cat->count); ?></data>
        </a>
      </li>
      <?php
        endforeach;
  ...
  <div class="product-showcase">
    ...
    if (!$bs_title) {
        $bs_title = __('Más vendidos', 'anon-theme');
    }
    ?>
